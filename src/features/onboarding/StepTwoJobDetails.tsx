...
export default function StepTwoJobDetails({ setIsStepValid }: StepProps) {
    ...
    type StepTwoFormData = Pick<OnboardingData, 'department' | 'role' | 'dateOfJoining'>;
  ...
  return (
    <Form {...form}>
        <form onSubmit={handleSubmit((data)=>console.log('Step 2 data saved:',data))} className="space-y-6">
            <FormField
                control={control}
                name="department"
